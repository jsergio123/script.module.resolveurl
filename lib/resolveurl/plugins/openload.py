...
class OpenLoadResolver(ResolveUrl):
    ...
    domains = [
        ...
        "oload.icu", "oload.fun", "oload.space", "openload.pw", "oload.monster"
    ]

    pattern = r'(?://|\.)(o(?:pen)??load\.(?:io|co|tv|stream|win|download|info|icu|fun|pw|space|monster))/(?:embed|f)/([0-9a-zA-Z-_]+)'
